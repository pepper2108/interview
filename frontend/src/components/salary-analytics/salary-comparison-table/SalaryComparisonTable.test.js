...
describe("SalaryComparisonTable", () => {
    ...
    it("renders correctly", () => {
        const wrapper = shallow(<SalaryComparisonTable columnsNames={["Column"]} filters={filters} rowValues={rowValues} />);

        expect(wrapper).toMatchSnapshot();
    });

    it("contains a header", () => {
        const { container } = render(<SalaryComparisonTable columnsNames={["Column"]} filters={filters} rowValues={rowValues} />);
